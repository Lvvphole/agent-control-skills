---
name: state-gate-controller
description: Control deterministic state transitions using persisted evidence and reject unsupported PASS transitions. Use when work moves between planned, executed, verified, evaluated, gated, or blocked states.
---

# state-gate-controller

## Fake PASS Rejection
Reject assistant-generated PASS states unless backed by persisted evidence from artifacts or command output.
