...
description: Evaluate only verifier-approved evidence against contract criteria. Use when pass/fail scoring must be separated from execution and verification.
---

# evaluator-protocol

## Evaluation Rule
Score only verifier-approved evidence against contract criteria. Do not inspect executor claims that lack verifier approval.
