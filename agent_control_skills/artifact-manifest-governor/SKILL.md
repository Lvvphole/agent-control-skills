---
name: artifact-manifest-governor
description: Specify artifact manifest records for evidence-bearing outputs. Use when artifacts, checksums, ownership, stage, verifier status, or evaluator status must be tracked.
---

# artifact-manifest-governor

## Manifest Fields
Every manifest record requires artifact ID, path, owner, stage, checksum, version, verifier status, and evaluator status.
