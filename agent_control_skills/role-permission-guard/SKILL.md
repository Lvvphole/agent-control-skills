...
description: Enforce planner, executor, verifier, evaluator, memory, escalation, and release role permissions. Use when one agent role may certify, approve, release, or complete its own work.
---

# role-permission-guard

## Role Prohibition
Executor cannot verify, evaluate, approve, release, or complete its own work.
