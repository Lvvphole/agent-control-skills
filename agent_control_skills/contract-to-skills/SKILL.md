---
name: contract-to-skills
description: Convert monolithic agent contracts into bounded skill package specifications. Use when a user asks to split a large deterministic multi-agent contract into small filesystem Agent Skills.
---
