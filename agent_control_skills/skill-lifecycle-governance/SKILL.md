...
description: Govern skill create, review, test, approve, version, deprecate, rollback, and retire states. Use when skills need enterprise review, risk controls, deployment management, or lifecycle tracking.
---

# skill-lifecycle-governance

## Lifecycle States
Use create, review, test, approve, version, deprecate, rollback, and retire states.
