---
name: memory-manager
description: Record verified package state, in-progress work, blockers, next actions, and known failure patterns. Use when durable project memory is needed without root-file mutation.
---

# memory-manager

## Memory Fields
Store completed verified items, in-progress work, blockers, next action, and known failure patterns.
