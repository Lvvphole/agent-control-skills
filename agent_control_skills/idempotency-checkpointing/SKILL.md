---
name: idempotency-checkpointing
description: Require idempotency keys and checkpoint records for side effects, artifact writes, tool calls, and state transitions. Use when repeatable execution or recovery is needed.
---

# idempotency-checkpointing

## Idempotency Rule
Require idempotency keys and checkpoint records for side effects, artifact writes, tool calls, and state transitions.
