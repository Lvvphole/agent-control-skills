---
name: execution-trigger-guard
description: Decide whether a request authorizes specification-only planning or actual file creation. Use when a task may accidentally mutate files without an explicit run or create instruction.
---
