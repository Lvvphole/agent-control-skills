...
description: Verify artifacts against structural requirements while rejecting prose-only explanations as evidence. Use when independent artifact checking is required before evaluation.
---

# verifier-protocol

## Verification Rule
Check artifacts only. Reject explanations, intentions, summaries, or assistant prose as evidence.
