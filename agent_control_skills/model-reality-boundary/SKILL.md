---
name: model-reality-boundary
description: Separate assistant claims from persisted tool evidence and reject fake PASS states. Use when status, verification, or completion depends on artifacts or command output.
---
